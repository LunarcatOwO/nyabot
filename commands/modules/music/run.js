...
exports.execute = async (ctx) => {
    const embed = new EmbedBuilder()
        ...
        .setDescription('Use the music player to play songs from YouTube, SoundCloud, and Spotify!')
        .addFields(
            { name: 'Playback', value: '`/music play <song>` - Play or search for music\n`/music pause` - Pause playback\n`/music resume` - Resume playback\n`/music stop` - Stop and clear queue\n`/music skip` - Skip current song', inline: false },
        ...
        .setFooter({ text: 'Tip: You can paste direct links from YouTube, SoundCloud, or Spotify!' });
